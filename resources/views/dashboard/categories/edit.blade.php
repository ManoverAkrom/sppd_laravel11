        ...
        <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
            <div class="flex flex-col items-center justify-center p-12 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                ...
                <div class="min-w-full whitespace-nowrap">
                    <form method="post" action="/dashboard/categories/{{ $category->code }}"
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full md:w-1/6 px-3 mb-6 md:mb-0">
                                    ...
                                    <input
                                        ...
                                        id="code" value="{{ old('code', $category->code) }}" name="code"
                                        type="text">
                                </div>
                                <div class="w-full md:w-4/6 px-3">
                                    ...
                                    <select
                                        ...
                                        @foreach ($names as $name)
                                            @if (old('name', $category->name) == $name)
                                ...
                                <div class="w-full md:w-1/6 px-3">
                                    ...
                                    <select
                                        ...
                                        @foreach ($colors as $color)
                                            @if (old('color', $category->color) == $color)
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('activity', $category->activity) }}">
                                </div>
                            </div>
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('transaction', $category->transaction) }}">
                                </div>
                            </div>
