<x-dashboard.layout>
    ...
    <div class="px-2 mx-auto mt-1 w-full ">
        <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg ">
                        ...
                        @foreach ($categories as $category)
                            <tr
                                ...
                                <td scope="row" class="w-10 ps-2 pe-1 py-3 text-left text-wrap border-1">
                                    {{ $category->code }}</td>
                                <td class="ps-2 pe-1 py-3 text-left text-wrap border-1 uppercase">{{ $category->name }}
                                </td>
                                ...
                                <td class="w-10 ps-2 pe-1 py-3 text-center text-wrap border-1">
                                    <span
                                        class="bg-{{ $category->color }}-100 text-gray-500 text-xs font-medium items-center px-3 py-1 rounded-xl dark:bg-gray-200 dark:text-gray-500 text-center">
                                        {{ $category->color }}
                                    </span>
                                </td>

                                <td class="w-38 px-2 py-3 text-center text-wrap">
                                    <a href="/dashboard/categories/{{ $category->code }}">
                                        <button type="button"
                                    ...
                                    <a href="/dashboard/categories/{{ $category->code }}/edit">
                                        <button type="button"
                                    ...
                                    <form action="/dashboard/categories/{{ $category->code }}" method="post"
                                        class="inline">
                                        @method('delete')
                                        @csrf
                                        <button
            ...
            <div class="p-8 mb-5 text-center">
