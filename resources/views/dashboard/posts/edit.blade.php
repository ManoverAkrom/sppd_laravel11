                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                                    ...
                                    <input
                                        ...
                                        id="sumber" value="{{ old('sumber', $post->sumber) }}" name="sumber"
                                        type="text">
                                    @error('sumber')
                                ...
                                <div class="w-full md:w-1/4 px-3">
                                    ...
                                    <input
                                        ...
                                        name="instansi" value="{{ old('instansi', $post->instansi) }}">
                                </div>
                                <div class="w-full md:w-1/4 px-3">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                        for="no_surat_sumber">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('no_surat_sumber', $post->no_surat_sumber) }}">
                                </div>
                                <div class="w-full md:w-1/4 px-3">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                    ...
                                    <input
                                        ...
                                        value="{{ old('tgl_surat_sumber', $post->tgl_surat_sumber) }}">
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full md:w-3/4 px-3">
                                    ...
                                    <textarea
                                        ...
                                        rows="3" id="hal_surat_sumber" name="hal_surat_sumber">{{ old('hal_surat_sumber', $post->hal_surat_sumber) }}</textarea>
                                </div>
                                ...
                                <div class="w-full md:w-1/4 px-3">
                                    ...
                                    {{-- <label for="file"
                                        ...
                                        <div class="flex flex-col items-center justify-center text-center pt-4 pb-6">
                                            <svg class="w-5 h-5 mb-2 text-gray-400" fill="none" stroke="currentColor"
                                            ...
                                            <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span
                                                    class="font-semibold text-wrap">Click to
                                                    upload</span> or drag and drop</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400">PDF (MAX. 2 MB)</p>
                                        </div>
                                        <input id="file" type="file"
                                            class="hidden @error('file') is-invalid @enderror" name="file"
                                            value="{{ old('file', $post->file) }}" />
                                    </label> --}}

                                    {{-- Upload File Fitur Preview --}}
                                    <div
                            ...
                            <div class="flex flex-wrap -mx-3 mb-2">
                                ...
                                <div class="w-full md:w-1/5 px-3 mb-6 md:mb-0">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('no_spt', $post->no_spt) }}" required>
                                    @error('no_spt')
                                        <div class="text-red-500">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="w-full md:w-2/5 px-3 mb-6 md:mb-0">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('tgl_spt', $post->tgl_spt) }}">
                                </div>
                            </div>
                        ...
                        <div class="part mb-3 pb-5 border-bottom">
                            ...
                            <div class="flex flex-wrap -mx-3 mb-2">
                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    ...
                                    <div class="relative">
                                        <input
                                            class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-400 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('name_id') is-invalid @enderror"
                                            id="name_id" placeholder="" name="name_id"
                                            value="{{ old('name_id', $post->name->name) }}" required disabled
                                            readonly>
                                        </input>
                                        @error('name_id')
                                    ...
                                    <div class="relative">
                                        <select
                                            ...
                                            @foreach ($users as $user)
                                                @if (old('follower_id', $post->follower_id) == $user->id)
                            ...
                            <div class="flex flex-wrap -mx-3 mb-2">
                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('tempat_tujuan', $post->tempat_tujuan) }}" required>
                                ...
                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    ...
                                    <div class="relative">
                                        <select
                                            class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                            id="tempat_berjalan" name="tempat_berjalan">
                                            @foreach ($ways as $way)
                                                @if (old('tempat_berjalan', $post->tempat_berjalan) == $way)
                                                    <option value="{{ $way }}" selected>
                                                        {{ $way }}
                                                    </option>
                                                @else
                            ...
                            <div class="flex flex-wrap -mx-3 mb-2">
                                <div class="w-full md:w-2/6 px-3">
                                    ...
                                    <input
                                        class="text-center appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                        id="tgl_berangkat" type="date" name="tgl_berangkat"
                                        value="{{ old('tgl_berangkat', $post->tgl_berangkat) }}" required>
                                </div>
                                <div class="w-full md:w-2/6 px-3">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                        for="tgl_kembali">
                                    ...
                                    <input
                                        class="text-center appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                        id="tgl_kembali" type="date" name="tgl_kembali"
                                        value="{{ old('tgl_kembali', $post->tgl_kembali) }}" required>
                                ...
                                <div class="w-full md:w-1/6 px-3 mb-6 md:mb-0">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('lama', $post->lama) }}" required>
                                </div>
                                <div class="w-full md:w-1/6 px-3 mb-6 md:mb-0">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                        for="jam_berangkat">
                                    ...
                                    <input
                                        class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 ps-8  leading-tight focus:outline-none focus:bg-white focus:border-gray-500 text-center"
                                        id="jam_berangkat" type="time" placeholder="" name="jam_berangkat"
                                        value="{{ old('jam_berangkat', $post->jam_berangkat) }}" required>
                            ...
                            <div class="flex flex-wrap -mx-3 mb-2">
                                <div class="w-full px-3 mb-6 md:mb-0">
                                    ...
                                    <textarea
                                        ...
                                        id="maksud" type="text" placeholder="" name="maksud">{{ old('maksud', $post->maksud) }}</textarea>
                                </div>
                            </div>
                            <div class="flex flex-wrap -mx-3 mb-2">
                                <div class="w-full px-3 mb-6 md:mb-0">
                                    ...
                                    <textarea
                                        ...
                                        id="keterangan" type="text" placeholder="" name="keterangan">{{ old('keterangan', $post->keterangan) }}</textarea>
                                </div>
                            </div>
                        </div>

                        <div class="flex flex-wrap -mx-3 mb-2 text-center">
                            <div class="w-11/12 px-3 mb-6 md:mb-0">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                    for="slug">
                                </label>
                                <input
                            ...
                            <div class="w-1/12 px-3 mb-6 md:mb-0" hidden>
                                ...
                                <input
                                    ...
                                    value="{{ $post->author_id }}"disabled readonly>
                            </div>
                        </div>
