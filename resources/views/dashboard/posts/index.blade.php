                    ...
                    <tbody>
                        ...
                        @foreach ($posts as $post)
                            <tr
                                ...
                                <td class="w-28 px-2 py-3 text-left text-wrap border-1">{{ $post->tempat_tujuan }}</td>
                                <td class="w-24 px-2 py-3 text-center text-wrap border-1">{{ $post->tgl_berangkat }}
                                </td>
                                <td class="w-5 px-2 py-3 text-center text-wrap border-1">
                                    <div class="flex justify-center items-center my-1 text-gray-500 text-wrap">
                                        <a href="/dashboard/posts?category={{ $post->category->slug }}"
                                            class="bg-{{ $post->category->color }}-100 text-gray-500 text-xs font-medium items-center px-3 py-1 rounded-xl dark:bg-gray-200 dark:text-gray-500 text-center">
                                            {{ $post->category->name }}
                                        </a>
                                    </div>
                                </td>
                                <td class="w-2 px-2 py-3 text-center text-wrap border-1">Disetujui</td>
